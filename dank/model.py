...
data, sampling_rate = librosa.load('kawaii/03-02-01-01-01-02-16.wav')
...
sr,x = scipy.io.wavfile.read('kawaii/03-02-01-01-01-02-16.wav')
...
for index,y in enumerate(mylist):
        X, sample_rate = librosa.load('kawaii/'+y, res_type='kaiser_fast',duration=5,sr=22050*2,offset=0.5)
